...
class BlogEtcCategoryAdminController extends Controller
{
    ...
    public function index(){
        ...
        return view("blog.blogetc_admin.categories.index")->withCategories($categories);
    }
    ...
    public function create_category(){
        ...
        return view("blog.blogetc_admin.categories.add_category");
    ...
    public function edit_category($categoryId){
        ...
        return view("blog.blogetc_admin.categories.edit_category")->withCategory($category);
    }
