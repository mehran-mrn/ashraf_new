...
class BlogEtcImageUploadController extends Controller
{
    ...
    {
        return view("blog.blogetc_admin.imageupload.index", ['uploaded_photos' => BlogEtcUploadedPhoto::orderBy("id", "desc")->paginate(10)]);
    }
    ...
    {
        return view("blog.blogetc_admin.imageupload.create", []);
    }
    ...
    public function store(UploadImageRequest $request)
    {
        ...
        return view("blog.blogetc_admin.imageupload.uploaded", ['images' => $processed_images]);
    }
