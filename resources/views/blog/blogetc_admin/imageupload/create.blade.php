                ...
                <form method='post' action='{{route("blogetc.admin.images.store")}}' enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6 form-group">
                            ...
                            <small id="image_title_help" class="form-text text-muted">{{__('messages.image_title')}}</small>
                        ...
                        <div class="col-12 col-md-6 form-group">
                            ...
                            <small id="blog_upload_help" class="form-text text-muted">{{__('messages.image_upload')}}</small>
                            ...
                            @foreach((array)config('blogetc.image_sizes') as $size => $image_size_details)
                                <div>
                                    <input type='checkbox' name='sizes_to_upload[{{$size}}]' value='true' checked
                                           id='size_{{$size}}'>
                                    <label for='size_{{$size}}'>{{$image_size_details['name']}}
                        ...
                        <div class="col-12 col-md-12 form-group pull-left">
                            <input type='submit' class='btn btn-primary pull-left' value='{{{__('messages.image_upload')}}}'>
                        </div>
                    </div>
                </form>
            </div>
