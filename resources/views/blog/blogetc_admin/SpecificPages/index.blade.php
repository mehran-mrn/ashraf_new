    ...
    <div class="content">
        <div class="container-fluid">
            <section>
                <button
                        ...
                        data-toggle="modal"
                        data-modal-title="{{trans('messages.add',['item'=>trans('messages.Specific_page')])}}"
                        data-target="#general_modal">{{__('messages.add_item',['item'=>__('messages.page')])}}
                </button>
            </section>
        </div>
                                        ...
                                        <div class="card-footer bg-light">
                                            <div class="btn-group pull-left">
                                                ...
                                                <button type="submit"
                                                        ...
                                                        data-ajax-link="{{route('blogetc.admin.SpecificPages.destroy_category',['id'=>$category->id])}}"
                                                        data-method="delete"
        ...
        @else
            @include('panel.not_found',['html'=>'<button class="btn btn-primary" data-toggle="modal" data-target="#general_modal">
                '.__('messages.page').'</button>',
                              'msg'=>__('messages.not_found_any_data'),
                           'des'=>__('messages.no_found_any',['item'=>__('messages.page')])])
        @endif
            ...
            <div class="modal-dialog ">
                <div class="modal-content">
                    <div class="modal-header bg-info">
                        <h6 class="modal-title">{{__('messages.Specific_page')}}</h6>
                        ...
                        <form method='post' action='{{route("blogetc.admin.SpecificPages.create_category")}}'
                            ...
                            <div class="form-group pull-left">
                                <button type='submit' class='btn btn-primary' value='Add new category'>
                                    {{trans('messages.add_new',['item'=>__('messages.page')])}}
                                </button>
                            </div>
