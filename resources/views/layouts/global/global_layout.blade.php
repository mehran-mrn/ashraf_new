...
<head>
    ...
    <link href="{{ URL::asset('/public/assets/global/images/apple-touch-icon-72x72.png') }}" rel="apple-touch-icon" sizes="72x72">
    <link href="{{ URL::asset('/public/assets/global/images/apple-touch-icon-114x114.png') }}" rel="apple-touch-icon" sizes="114x114">
    <link href="{{ URL::asset('/public/assets/global/images/apple-touch-icon-144x144.png') }}" rel="apple-touch-icon" sizes="144x144">
    ...
    <link id="menuzord-menu-skins" href="{{ URL::asset('/public/assets/global/css/menuzord-skins/menuzord-rounded-boxed.css') }}" rel="stylesheet"/>
    <!-- CSS | Main style file -->
    ...
    <link href="{{ URL::asset('/public/assets/global/css/custom-bootstrap-margin-padding.css') }}" rel="stylesheet" type="text/css">
    ...
    <link href="{{ URL::asset('/public/assets/global/css/style-main-rtl-extra.css') }}" rel="stylesheet" type="text/css">
    <!-- CSS | Style css. This is the file where you can place your own custom css code. Just uncomment it and use it. -->
    <!-- <link href="css/style.css" rel="stylesheet" type="text/css"> -->

    <!-- Revolution Slider 5.x CSS settings -->
    <link  href="{{ URL::asset('/public/assets/global/js/revolution-slider/css/settings.css') }}" rel="stylesheet" type="text/css"/>
    <link  href="{{ URL::asset('/public/assets/global/js/revolution-slider/css/layers.css') }}" rel="stylesheet" type="text/css"/>
    <link  href="{{ URL::asset('/public/assets/global/js/revolution-slider/css/navigation.css') }}" rel="stylesheet" type="text/css"/>
...
<script type="text/javascript" src="{{ URL::asset('/public/assets/global/js/revolution-slider/js/extensions/revolution.extension.actions.min.js') }}"></script>
<script type="text/javascript" src="{{ URL::asset('/public/assets/global/js/revolution-slider/js/extensions/revolution.extension.carousel.min.js') }}"></script>
<script type="text/javascript" src="{{ URL::asset('/public/assets/global/js/revolution-slider/js/extensions/revolution.extension.kenburn.min.js') }}"></script>
<script type="text/javascript" src="{{ URL::asset('/public/assets/global/js/revolution-slider/js/extensions/revolution.extension.layeranimation.min.js') }}"></script>
<script type="text/javascript" src="{{ URL::asset('/public/assets/global/js/revolution-slider/js/extensions/revolution.extension.migration.min.js') }}"></script>
<script type="text/javascript" src="{{ URL::asset('/public/assets/global/js/revolution-slider/js/extensions/revolution.extension.navigation.min.js') }}"></script>
<script type="text/javascript" src="{{ URL::asset('/public/assets/global/js/revolution-slider/js/extensions/revolution.extension.parallax.min.js') }}"></script>
<script type="text/javascript" src="{{ URL::asset('/public/assets/global/js/revolution-slider/js/extensions/revolution.extension.slideanims.min.js') }}"></script>
<script type="text/javascript" src="{{ URL::asset('/public/assets/global/js/revolution-slider/js/extensions/revolution.extension.video.min.js') }}"></script>
