                ...
                <div class="dropdown-menu dropdown-menu-right dropdown-content wmin-md-300">
                    ...
                    <div class="dropdown-content-body dropdown-scrollable">
                        <ul class="media-list">
                            <li class="media">
                                <div class="mr-3">
                                    <img src="{{URL::asset(user_information('avatar'))}}" width="36" height="36"
                                         class="rounded-circle" alt="">
                                </div>
                                <div class="media-body">
                                    <a href="#"
                                       class="media-title font-weight-semibold">{{user_information('full')}}</a>
            ...
            <li class="nav-item dropdown dropdown-user">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <a href="{{route('logout')}}" class="dropdown-item"><i
                                class="icon-switch2"></i>{{__('messages.logout')}}</a>
                </div>
            </li>
        </ul>
    </div>
