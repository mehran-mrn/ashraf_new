...
<head>
  ...
  <link rel="stylesheet" href="{{ URL::asset('/public/vendor/laravel-filemanager/css/cropper.min.css') }}">
  <link rel="stylesheet" href="{{ URL::asset('/public/vendor/laravel-filemanager/css/dropzone.min.css') }}">
  <link rel="stylesheet" href="{{ URL::asset('/public/vendor/laravel-filemanager/css/mime-icons.min.css') }}">
...
<body>
  ...
  <script src="{{ URL::asset('/public/vendor/laravel-filemanager/js/cropper.min.js') }}"></script>
  <script src="{{ URL::asset('/public/vendor/laravel-filemanager/js/dropzone.min.js') }}"></script>
  <script>
