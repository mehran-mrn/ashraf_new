...
<form method="POST" id="register_user_panel" class="form-ajax-submit" action="{{ route('panel_register_user') }}">
    ...
    <div class="form-group row ">
        <div class="col-md-6 offset-md-4">
            <span class="text-info"><i class="text-info">*</i>  حداقل یکی از دو فیلد تلفن یا ایمیل، باید تکمیل شود
            </span>
        </div>
    </div>
    ...
    <div class="form-group row">
        <label for="email" class="col-md-4 col-form-label text-md-right">{{ __('messages.email') }}<i class="text-info">*</i></label>
    ...
    <div class="form-group row">
        <label for="phone" class="col-md-4 col-form-label text-md-right">{{ __('messages.phone') }}<i class="text-info">*</i></label>
