        ...
        <div class="row">
            ...
            <div class="col-md-6 ">
                <div class="card border-1 border-blue-400">
                    <div
                        class="card-header alpha-blue text-blue-800 border-bottom-blue header-elements-inline justify-content-between">
                        ...
                        <button type="button" class="btn bg-blue-700 btn-lg modal-ajax-load"
                                data-ajax-link="{{route('assign_user_to_permission_form',['permission_id'=>$permission['id']])}}"
                                data-toggle="modal"
            ...
            <div class="col-md-6 ">
                <div class="card border-1 border-blue-400">
                    <div
                        ...
                        <button type="button" class="btn bg-blue-700 btn-lg modal-ajax-load"
                                data-ajax-link="{{route('assign_role_to_permission_form',['permission_id'=>$permission['id']])}}"
                                data-toggle="modal"
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            @foreach($teams_roles as $team => $roles)
                                <tr>
                                    ...
                                    <th>
                                        <button type="button"
                                                class="btn btn-outline-success btn-sm legitRipple modal-ajax-load"
                                                data-ajax-link="{{route('assign_role_to_permission_form',['permission_id'=>$permission['id'],'team_id'=>$team])}}"
                                                data-toggle="modal"
                                                data-modal-title="{{trans('messages.add_new',['item'=>trans('messages.role')])}}"
                                                data-modal-size="modal-lg"
                                                data-target="#general_modal">
                                        ...
                                        <button type="button"
                                                class="btn btn-outline-success btn-sm legitRipple swal-alert"
