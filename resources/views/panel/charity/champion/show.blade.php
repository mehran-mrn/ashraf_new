    ...
    <section>
        <div class="content">
            <div class="container-fluid">
                <section>
                    <a href="{{route('charity_champion_payments')}}"
            ...
            <section>
                <div class="card">
                    <div class="card-header">
                        <h6 class="card-title text-black">{{__('messages.champions_payments')}}
                            |
                            {{$info['name']!=""?$info['name']." ".$info['last_name']:''}}
                            {{$info['user_id']!=0?$info['user']['people']['name']." ".$info['user']['people']['family']:''}}
                        </h6>
                        <hr>
                    </div>
                    <div class="card-body">
                        <div class="text-center mb-3 py-2">
                            <h4 class="font-weight-semibold mb-1">{{$info['champion']['title']}}</h4>
                        </div>
                        <div class="container">
                            <hr>
                            <div class="row">
                                ...
                                @if($info['last_name']!="")
                                    <div class="col-6 py-2">
                                        <strong>{{__('messages.family')}}:</strong> {{$info['last_name']}}
                                    </div>
                                @endif
                                @if($info['user_id']!=0)
                                    <div class="col-6 py-2">
                                        <strong>{{__('messages.name')}}:</strong> {{$info['user']['people']['name']}}
                                    </div>
                                @endif
                                @if($info['user_id']!=0)
                                    <div class="col-6 py-2">
                                        <strong>{{__('messages.family')}}:</strong> {{$info['user']['people']['family']}}
                                    </div>
                                @endif
                                @if($info['phone']!="")
                                    <div class="col-6 py-2">
