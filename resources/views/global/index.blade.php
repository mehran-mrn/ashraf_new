            ...
            <div class="section-content">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <h3 class="line-bottom">حالت چطوره؟</h3>
                        <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد.</p>
                        <a class="text-theme-colored font-13 pull-left" href="page-about1.html">ادامه مطلب...</a>
                    </div>
                    <div class="col-md-6">
                        <h3 class="line-bottom mt-0 mt-sm-30">اعلام وضعیت</h3>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-md-6">
                                <div class="icon-box p-0 mb-30">
                                    <a class="icon icon-sm pull-left sm-pull-none flip bg-theme-colored mb-sm-15 mb-0 ml-10" href="#">
                                        <i class="flaticon-charity-shelter text-white font-36"></i>
                                    </a>
                                    <h4 class="icon-box-title m-0 mb-5">تماس ها</h4>
                                    <p class="text-gray mb-5">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است...</p>
                                    <a href="#" class="text-theme-colored font-13 pull-left">ادامه مطلب</a>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-6">
                                <div class="icon-box p-0 mb-30">
                                    ...
                                    <h4 class="icon-box-title m-0 mb-5">کمک و یاری</h4>
                                    <p class="text-gray mb-5">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است...</p>
                                    <a href="#" class="text-theme-colored font-13 pull-left">ادامه مطلب</a>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-6">
                                <div class="icon-box p-0 mb-30">
                                    ...
                                    <h4 class="icon-box-title m-0 mb-5">طبقه بندی</h4>
                                    <p class="text-gray mb-5">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است...</p>
                                    <a href="#" class="text-theme-colored font-13 pull-left">ادامه مطلب</a>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-6">
                                <div class="icon-box p-0 mb-30">
                                    ...
                                    <h4 class="icon-box-title m-0 mb-5">ویژگی</h4>
                                    <p class="text-gray mb-5">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است...</p>
                                    <a href="#" class="text-theme-colored font-13 pull-left">ادامه مطلب</a>
                                </div>
                            </div>
