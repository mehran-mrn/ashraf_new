                ...
                <div class="col-md-5">
                    ...
                    @if($key !=0)
                        <article class="post media-post clearfix pb-0 mb-10">
                            <a href="#" class="post-thumb post-thumb-img mb-0"><img alt="" src="{{ URL::asset('public/'.config('blogetc.blog_upload_dir'))."/".$news['image_medium']}}">
                            ...
                            <div class="post-right">
                                <h4 class="mt-0 mb-5"><a href="page-single-event.html">{{$news['title']}}</a></h4>

                                <p class="mb-0 font-13">{{$news['short_description'] }}</p>
                                <a class="text-theme-colored font-13" href="page-single-event.html">{{trans('messages.read_more')}}...</a>
                            </div>
                        </article>
                        @endif
                    @endforeach
