...
@section('footer_js')
    <script>
        ...
        $(document).on("click", '.hidden-file-form', function () {
            //alert($( this ).css( "transform" ));
                                    ...
                                    @foreach($active_caravans as $caravan)
                                        ...
                                        <li class="active">
                                            <a href="#tab_{{$caravan['id']}}"
                                               data-toggle="tab">
                                                <div class="text-info inline-block">{{get_cites($caravan['dep_city'])['name']}} </div>
                                                |
                                                <div class="text-info inline-block">{{miladi_to_shamsi_date($caravan['start'])}}</div>
                                            ...
                                            <div class="panel">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-2 col-xs-6 pt-xs-10">
                                                                        <a onclick="printDiv('print_{{$caravan['id']}}')"
                                                                           class="btn btn-warning btn-block ajaxload-popup">{{__('words.print')}}
                                                                            <i class="fa fa-print"></i> </a>
                                                                    </div>
                                                                    <div class="col-md-2 col-xs-6 pt-xs-10 ">
                                                                        <a href="#collapse_add_to_team"
                                                                           class="btn btn-theme-colored btn-block hidden-form"
                                                                           data-toggle="collapse"
                                                                           data-parent="#accordion"
                                                                        >{{__('messages.new_register')}}
                                                                    ...
                                                                    <div class="col-md-2 col-xs-6 pt-xs-10 ">
                                                                        <a href="#collapse_upload_doc"
                                                                           class="btn btn-theme-colored btn-block hidden-file-form"
                                                                           data-toggle="collapse"
                                                                           data-parent="#accordion"
                                                                        >{{__('messages.doc_upload')}}
                                                ...
                                                <div class="panel-body bg-white-f9" >
                                                    ...
                                                    <div id="collapse_add_to_team" class="collapse ">
                                                        ...
                                                        <form action="{{route('add_person_to_caravan_excel')}}"
                                                              method="post" enctype="multipart/form-data">

                                                            <div class="col-md-3">
                                                                <a class="text-theme-colored"
                                                                   href="{{url('public/files/sample_file.xlsx')}}"><i
                                                                            class="fa fa-file-excel-o"></i> {{trans('messages.download_sample_file')}}
                                                                </a>
                                                            </div>
                                                            <div class="col-md-9">
                                                    ...
                                                    <div id="collapse_upload_doc" class="collapse ">

                                                        <div class="col-md-7">
                                                            <div class="font-weight-bolder text-center">
                                                                <b>{{trans('messages.new_doc_upload')}}</b></div>
                                                            <br>
                                                            <?php
                                                            $caravan_doc = null;
                                                            ?>
                                                            @include('panel.caravan.materials.upload_doc_form')
                                                        </div>
                                                        <div class="col-md-5">
                                                            <div class="font-weight-bolder text-center">
                                                                ...
                                                                <div style="border-radius: 5px" class="panel bordered  border-theme-color-2px">
                                                                    <form class="m-0" method="post"
                                                                        ...
                                                                        <div style="padding: 8px 22px"
                                                                             class=" inline-block">{{$caravan_doc['doc']['title']}} </div>
                                                                        <label style="padding: 8px 22px"
                                                                               class=" label label-info">{{miladi_to_shamsi_date($caravan_doc['created_date'])}}</label>
                                                                        <label style="padding: 8px 22px"
                                                                               class="p-2 label label-warning">.{{$caravan_doc['doc']['mime']}} </label>

                                                                        @csrf
                                                                        <input type="hidden" name="doc_id"
                                                                               value="{{$caravan_doc['doc']['id']}}">
                                                                        <button class="pull-left btn btn-link text-theme-colored"
                                                                                type="submit">{{trans('words.download')}}
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="p-2">
                                                                        @if($person_caravan['accepted'] >='1')
                                                                            <label class="label label-success">{{trans('messages.accepted')}}</label>
                                                                        @elseif($person_caravan['accepted'] =='0')
                                                                            <label class="label label-danger">{{trans('messages.rejected')}}</label>
                                                                        @else
                                                                            <label class="label label-warning">{{trans('messages.pending')}}</label>
                                                                        @endif
                                                                    </td>
                                                                </tr>
                                                            @endforeach
